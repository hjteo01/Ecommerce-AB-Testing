...
## Codes
The Python Codes used to inspect and determined whether observed differences were statistically significant using Chi-square test χ² of Independences can be found [here](AB_Testing.ipynb).
...
[Visualization: Conversion Rate Comparison](visualizations/Conversion-Rates.png)
...
[Visualization: Mosaic Plot of Chi-Square Test](visualizations/Chi-Square-Plot2.png)
...
The test was conducted over a limited timeframe (for January 2026); longer-term trends may differ.
